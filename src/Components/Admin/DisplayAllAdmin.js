...
//     <Container>
//        <Button> <LinkContainer to="/AddAdmin">
//     <Nav.Link className="nav-links">ADD Admin</Nav.Link>
...
deleteUser(id) {
  ...
  componentDidMount(){
    ...
    AdminService.fetchAdmin().then((response) => {
  ...
  render(){
    ...
    <Button> <LinkContainer to="/AddAdmin">
  <li className="nav-links">ADD Admin</li>
    </LinkContainer></Button>
    </Container> {
              <table className='table table-striped'>
                <tr>
